...
package com.social.bubbles.foursquare;
...
public abstract class FSAsyncRequestListener implements RequestListener {
    ...
    public abstract void onComplete(JSONObject obj, final Object state) throws JSONException;
